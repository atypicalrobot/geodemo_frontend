...
export default defineMessages({
  ...
  scaffoldingHeader: {
    id: 'boilerplate.containers.AboutPage.scaffolding.header',
  ...
  feedbackHeader: {
    id: 'boilerplate.containers.AboutPage.feedback.header',
    defaultMessage: 'Instant feedback',
  },
  feedbackMessage: {
    id: 'boilerplate.containers.AboutPage.feedback.message',
    defaultMessage: `
  ...
  stateManagementHeader: {
    id: 'boilerplate.containers.AboutPage.state_management.header',
    defaultMessage: 'Predictable state management',
  },
  stateManagementMessages: {
    id: 'boilerplate.containers.AboutPage.state_management.message',
    defaultMessage: `
  ...
  javascriptHeader: {
    id: 'boilerplate.containers.AboutPage.javascript.header',
    defaultMessage: 'Next generation JavaScript',
  },
  javascriptMessage: {
    id: 'boilerplate.containers.AboutPage.javascript.message',
    defaultMessage: `Use template strings, object destructuring, arrow functions, JSX
    syntax and more, today.`,
  },
  cssHeader: {
    id: 'boilerplate.containers.AboutPage.css.header',
    defaultMessage: 'Abouts',
  },
  cssMessage: {
    id: 'boilerplate.containers.AboutPage.css.message',
    defaultMessage: 'Next generation CSS',
  },
  routingHeader: {
    id: 'boilerplate.containers.AboutPage.routing.header',
    defaultMessage: 'Industry-standard routing',
  },
  routingMessage: {
    id: 'boilerplate.containers.AboutPage.routing.message',
    defaultMessage: `
  ...
  networkHeader: {
    id: 'boilerplate.containers.AboutPage.network.header',
    defaultMessage: 'Offline-first',
  },
  networkMessage: {
    id: 'boilerplate.containers.AboutPage.network.message',
    defaultMessage: `
  ...
  intlHeader: {
    id: 'boilerplate.containers.AboutPage.internationalization.header',
    defaultMessage: 'Complete i18n Standard Internationalization & Pluralization',
  },
  intlMessage: {
    id: 'boilerplate.containers.AboutPage.internationalization.message',
